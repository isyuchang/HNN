function [L,E] = HRPCA2D_MC(Y,Support,varargin)
% =========================
%  haart2
% =========================
% =========================
...
[maxIter, tol, rho, lambda, mu_a, mu_b, gamma, debug, E, L, print_freq, GT] = ...
